...
class ActionableStepContextTagRepository(BaseRepository):
    ...
    tag_ids: Optional[List[str]] = None
        ...
        print(f"Input - context_ids: {context_ids}")
        ...
        if context_ids and tag_ids:
            ...
            query = query.where('user_context_id', 'in', context_ids).where('user_tag_id', 'in', tag_ids)
        elif context_ids:
            ...
            print("No filtering conditions provided, returning empty list")
            return []
        ...
        if docs:
            print("Sample document data:", docs[0].to_dict())
        else:
